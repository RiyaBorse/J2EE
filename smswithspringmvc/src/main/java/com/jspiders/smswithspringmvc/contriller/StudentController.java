package com.jspiders.smswithspringmvc.contriller;
...
public class StudentController {
	...
	public String getPageToSearchStudent1(HttpSession httpSession) {
		AdminPOJO admin = (AdminPOJO) httpSession.getAttribute("admin");
		if (admin != null) {
			return "search_id";
		} else {
	...
	@RequestMapping(path = "/search_id", method = RequestMethod.POST)
	...
	public String getPageToSearchStudent2(HttpSession httpSession) {
		AdminPOJO admin = (AdminPOJO) httpSession.getAttribute("admin");
		if (admin != null) {
			return "search_em";
		} else {
	...
	@RequestMapping(path = "/search_em", method = RequestMethod.POST)
	public String searchStudentByEmail(@RequestParam String epattern, ModelMap modelMap) {
		List<StudentPOJO> students = studentService.searchStudentByEmail(epattern);
		modelMap.addAttribute("students", students);
		return "search_em";
	}
	
	@RequestMapping(path = "/search_age", method = RequestMethod.GET)
	public String getPageToSearchStudent3(HttpSession httpSession) {
		AdminPOJO admin = (AdminPOJO) httpSession.getAttribute("admin");
		if (admin != null) {
			return "search_age";
		} else {
	...
	@RequestMapping(path = "/search_age", method = RequestMethod.POST)
